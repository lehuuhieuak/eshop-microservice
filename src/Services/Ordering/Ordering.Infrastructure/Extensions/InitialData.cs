namespace Ordering.Infrastructure.Extensions
{
    public class InitialData
    {
        ...
        {
            Customer.Create(CustomerId.Of(Guid.NewGuid()), "hieulh", "hieulh@gmail.com"),
            Customer.Create(CustomerId.Of(Guid.NewGuid()), "hieulh1", "hieulh1@gmail.com")
        };

        public static IEnumerable<Product> Products => new List<Product>
        {
            Product.Create(ProductId.Of(Guid.NewGuid()), "IPhone X", 500),
            Product.Create(ProductId.Of(Guid.NewGuid()), "IPhone 11", 700),
            Product.Create(ProductId.Of(Guid.NewGuid()), "IPhone 12", 900)
        };
